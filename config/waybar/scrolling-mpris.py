# Vendored from HANCORE-linux/waybar-themes V7.2b (MIT), drdeltree.
# Scrolling MPRIS text for the custom/mpris module, credited to Mezutelni in the
# upstream README. Stdlib only; needs playerctl. See THIRD_PARTY_NOTICES.md.
import subprocess
import time
import json
import sys
